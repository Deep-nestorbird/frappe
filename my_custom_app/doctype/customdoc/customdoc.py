...
# Import the Document class from frappe.model.document module
...
class customdoc(Document):
    ...
    def autoname(self):
        # Generate the name based on the value of the 'full_name' field
        if self.full_name:
            self.name = self.generate_name_from_field(self.full_name)
